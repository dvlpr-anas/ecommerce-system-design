...
- Managed Postgres with PITR enabled ([`../07-cloud-infrastructure/terraform-skeleton.md`](../07-cloud-infrastructure/terraform-skeleton.md) `modules/postgres/`. Local schema reference [`../02-platform-services/postgres.md`](../02-platform-services/postgres.md))
- Managed Kafka with replication ≥ 3 across AZs ([`../07-cloud-infrastructure/terraform-skeleton.md`](../07-cloud-infrastructure/terraform-skeleton.md) `modules/kafka/`. Topic spec from [`../02-platform-services/kafka.md`](../02-platform-services/kafka.md))
- Sealed Secrets keys backed up out-of-band ([`../07-cloud-infrastructure/sealed-secrets.md`](../07-cloud-infrastructure/sealed-secrets.md))
