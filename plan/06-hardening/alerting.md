...
- [`runbooks.md`](./runbooks.md) template in place
- Alertmanager wired to Slack + PagerDuty ([`../02-platform-services/observability-metrics.md`](../02-platform-services/observability-metrics.md))
