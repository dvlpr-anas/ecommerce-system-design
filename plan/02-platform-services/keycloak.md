...
- Keycloak HA needs >= 2 replicas + shared cache (Infinispan). Single replica is fine for dev/staging. Bump for prod in `08-cloud-deployment/service-manifests.md` and validate in `08-cloud-deployment/disaster-recovery.md`.
