...
- [`terraform-skeleton.md`](./terraform-skeleton.md) applied for the dev environment (cluster exists)
...
5. [ ] Install Kong ingress controller via Helm into `platform` namespace (config mirrors the local declarative config from [`../02-platform-services/kong-gateway.md`](../02-platform-services/kong-gateway.md), adapted for K8s ingress) (effort: M)
